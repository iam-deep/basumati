        ...
        <div class="container">
            <div class="wt-topbar-right">
                <ul class="list-unstyled e-p-bx">
                    <li><i class="fa fa-envelope"></i>basumatiincorporation@gmail.com</li>
                    <li><i class="fa fa-phone"></i>9051077126</li>
                </ul>
            ...
            <div class="container">
                ...
                <div class="header-nav navbar-collapse collapse ">
                    <ul class=" nav navbar-nav">
                        ...
                        <li>
                            <a href="{{ url('/team') }}">Team<!--<i class="fa fa-chevron-down"></i>--></a>
                            {{-- <ul class="sub-menu">
                                <li>
                        ...
                        <li class="submenu-direction">
                            <a href="{{ url('/contact') }}">Contact<!--<i class="fa fa-chevron-down"></i>--></a>
                            {{-- <ul class="sub-menu">
                                <li>
